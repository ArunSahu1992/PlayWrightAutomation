...
namespace TestCases
{
    public class TC_006_UploadCityDataToServer_MN_18_3 : ITestCase
    {
        public string TestCaseId => "TC_006_UploadCityDataToServer_MN_18_3";
        ...
        public async Task ExecuteAsync(AutomationContext automationContext, ILogger logger)
        {
            ...
            try
            {
                ...
                {
                    HasText = "Works Taken-up in Current year(Spill over+New) for Agriculture"
                }).ClickAsync();
                ...
                var cityLinks = page.Locator("table tr td:first-child a[href*='agri_exp_n.aspx']");
                ...
                if (cityCount == 0)
                {
                    ...
                    cityLinks = page.Locator("table tr td:first-child a[href*='agri_exp_n.aspx']");
                ...
                try
                {
                    for (int i = 0; i < cityCount; i++)
                    {
                        ...
                        var cityLink = page.Locator("table tr td:first-child a[href*='agri_exp_n.aspx']").Nth(i);
                        ...
                        // Go back
                        await page.ClickAsync("#ctl00_ContentPlaceHolder1_back");
                    }
