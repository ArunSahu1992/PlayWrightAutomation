...
namespace TestCases
{
    public class TC_004_UploadCityDataToServer_MR_3C : ITestCase
    {
        public string TestCaseId => "TC_004_UploadCityDataToServer_MR_3C";
        ...
        public async Task ExecuteAsync(AutomationContext automationContext, ILogger logger)
        {
            ...
            try
            {
                ...
                await page.ClickAsync("#RptrPhaseIIMISreport_ctl02_lnkbtn_PageLinkHeader");
                await page.WaitForLoadStateAsync(LoadState.Load);
                ...
                try
                {
                    ...
                    for (int i = 0; i < blockCount; i++)
                    {
                        ...
                        // Go back
                        await page.ClickAsync("#ctl00_ContentPlaceHolder1_lnkback");
                    }
