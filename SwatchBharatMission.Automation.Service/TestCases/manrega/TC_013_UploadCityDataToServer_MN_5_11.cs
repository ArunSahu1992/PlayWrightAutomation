...
namespace TestCases
{
    public class TC_013_UploadCityDataToServer_MN_5_11 : ITestCase
    {
        public string TestCaseId => "TC_013_UploadCityDataToServer_MN_5_11";
        ...
        public async Task ExecuteAsync(AutomationContext automationContext, ILogger logger)
        {
            ...
            try
            {
                ...
                var cityLinks = page.Locator("table tr td:nth-child(2) a[href*='demregister.aspx']");
                ...
                if (cityCount == 0)
                {
                    ...
                    cityLinks = page.Locator("table tr td:nth-child(2) a[href*='demregister.aspx']");
                ...
                try
                {
                    for (int i = 0; i < cityCount; i++)
                    {
                        ...
                        var cityLink = page.Locator("table tr td:nth-child(2) a[href*='demregister.aspx']").Nth(i);
                        ...
                        // Go back
                        await page.Locator("#ContentPlaceHolder1_back").ClickAsync();
